...
> SSH access, line security, interface management, and OSI model flow analysis.

02. **Ethernet Switching**  
Layer 2 technologies focusing on loop prevention and logical segmentation.
> VLAN/Trunking (802.1Q), VTP/DTP, STP (802.1D) tuning, Rapid-PVST+, and LACP EtherChannel.

03. **IP Routing & Services**  
Advanced Layer 3 configurations, dynamic routing protocols, and redundancy.
> OSPFv2 (Multi-area), EIGRP, Floating Static Routes, HSRP (First Hop Redundancy), and DHCP Server/Relay.

04. **IPv6 Fundamentals**  
Migration and configuration of IPv6 networks.  
> IPv6 SLAAC, Stateful DHCPv6, and IPv6 Static/Default routing.
